...
export function NotificationBell({ userId }: NotificationBellProps) {
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      {/* Dropdown panel */}
      {open && (
        <div className="absolute right-0 top-full mt-2 w-80 max-w-[calc(100vw-2rem)] bg-surface rounded-2xl shadow-lg border border-golf-gray-100 z-50 overflow-hidden">
          {/* Header */}
