...
export async function POST(request: NextRequest) {
  try {
    ...
    await transporter.sendMail({
      ...
      to: parentEmail,
      subject: `Coach reviewed ${studentName}'s round — ${courseName} (${scoreToParStr})`,
      html: `
        <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto;">
          <h2 style="color: #16a34a;">Coach Review Complete</h2>
          <p>Hi ${greetingName},</p>
          <p>Coach has reviewed <strong>${studentName}</strong>&rsquo;s round and left feedback.</p>
    ...
    console.error('notify-parent-review error:', err);
